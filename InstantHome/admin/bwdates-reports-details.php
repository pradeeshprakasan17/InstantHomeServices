...
<h5 align="center" style="color:blue">Report from <?php echo $fdate?> to <?php echo $tdate?></h5>
               <table class="table table-striped table-advance table-hover">
                ...
                <tbody>
                  <?php
                 $tid= $_SESSION['tid'];
$ret=mysqli_query($con,"select tbluser.*,tblrequest.* from tblrequest join tbluser on tbluser.ID=tblrequest.UserID where (date(ReqDate) between '$fdate' and '$tdate')");
$cnt=1;
