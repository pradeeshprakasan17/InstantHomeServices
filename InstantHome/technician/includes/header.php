    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="dashboard.php" class="logo"><b>TECHNICIAN<span> PAGE</span></b></a>
      <!--logo end-->
      <div class="nav notify-row" id="top_menu">
        ...
        <ul class="nav top-menu">
          ...
          <li id="header_notification_bar" class="dropdown">
            <?php
           $tid=$_SESSION['tid'];
$ret1=mysqli_query($con,"select tblrequest.ID,tblrequest.ServiceNumber,tblrequest.ServiceNumber from tblrequest where tblrequest.Status='Approved' && tblrequest.AssignTo='$tid'");
...
while($result=mysqli_fetch_array($ret1))
{
            ...
            <?php }}?>
              <li>
                <a href="new-service-request.php">See all new notifications</a>
              </li>
            </ul>
          </li>
