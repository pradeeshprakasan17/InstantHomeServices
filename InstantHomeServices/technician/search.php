...
<head>
  ...
  <title>Search Service Request</title>
  ...
  <?php include_once('includes/sidebar.php');?>
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Search Service Request</h3>
        <div class="row mb">
          <!-- page start-->
             ...
             <div class="form-panel">
              <form role="form" class="form-horizontal style-form" method="post">
                ...
                <div class="form-group has-success">
                  <label class="col-lg-2 control-label">Search by Service Number</label>
                  <div class="col-lg-10">
                ...
                <div class="form-group">
                  <div class="col-lg-offset-2 col-lg-10">
                    <button class="btn btn-theme" type="submit" name="search">Search</button>
                  </div>
                </div>
              </form>
            </div>
  ...
  <h4 align="center">Result against "<?php echo $sdata;?>" keyword </h4>
             <table class="table table-striped table-advance table-hover">
                ...
                <tbody>
                  <?php
                 $tid= $_SESSION['tid'];
$ret=mysqli_query($con,"select tbluser.*,tblrequest.* from tblrequest join tbluser on tbluser.ID=tblrequest.UserID where ServiceNumber like '%$sdata%' && (Status='Completed' ||Status='Approved') && (AssignTo='$tid')");
