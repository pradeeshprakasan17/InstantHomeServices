...
<head>
  ...
  <title>Assign Service Request</title>
  ...
  <?php include_once('includes/sidebar.php');?>
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Assign Service Request</h3>
        <div class="row mb">
          <!-- page start-->
          <div class="content-panel">
           ...
           <table class="table table-striped table-advance table-hover">
                ...
                <tbody>
                  <?php
$ret=mysqli_query($con,"select tbluser.*,tblrequest.* from tblrequest join tbluser on tbluser.ID=tblrequest.UserID where Status='Approved'");
$cnt=1;
