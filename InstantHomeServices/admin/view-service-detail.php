 ...
 if(isset($_POST['submit']))
  {
   ...
   $query=mysqli_query($con, "update   tblrequest set Status='$status',Remark='$remark',AssignTo='$assignee' where ServiceNumber='$vid'");
    if ($query) {
...
<option value="<?php echo htmlentities($row['TechnicianID']);?>"><?php echo htmlentities($row['TechnicianID']);?></option>
 <?php } ?>
    </select></td>
  </tr>                  
