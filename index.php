...
<html lang="en">
<head>
<title>Instant Home Services | Home Page</title>
 ...
 ?>
			...
			<div class="header">
				...
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">Home Service System</a></h1>
				</div>
							...
							<ul class="slides">
								<li>
									<div class="agileits_w3layouts_banner_info">
										<h3>Instant Home Services</h3>
										<p>We on the Instant Home Services are eager to present you with provide every possible services to the customers,while they are in need of the service for their house </p>
									</div>
								</li>
								<li>
									<div class="agileits_w3layouts_banner_info">
										<h3>Safety In The Home</h3>
										<p>We provide Services to customers using the certified service providers who are Well versed at their Job and Trust worthy</p>
									</div>
								</li>
								<li>
									<div class="agileits_w3layouts_banner_info">
										<h3>Tools & Specialist Equipment</h3>
										<p>Instant Home Services provides the business oppurtunities to the service providers</p>
									</div>
								</li>
							</ul>
						</div>
...
<div class="footer">
		<div class="container">
		<h2 class="wthree_head">Instant Home Services</h2>
 ...
 ?>
					...
					<div class="col-md-4 w3agile_footer_grid w3agile_footer_grid1">
						<h3>Home Services</h3>
						<img src="images/blog_617882081.jpg" width="400" height="180">
	...
	<div class="w3_agileits_copy_right_social">
		<div class="container">
			<div class="col-md-6 agileits_w3layouts_copy_right">
				<p>© 2022 Instant Home Services</p>
			</div>
